...
public class HiddenWheelView extends FrameLayout {
    ...
    public HiddenWheelView(Context context, AttributeSet attrs) {
        ...
        try {
            mHeight = (int) typedArray.getDimension(0,
                    TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, context.getResources().getDisplayMetrics()));
        } catch (UnsupportedOperationException e) {
            mHeight = mItemCount * mItemHeight;
        } finally {
            typedArray.recycle();
        }
        ...
        mPadding = (mHeight - mItemHeight) / 2;
        ...
        mRecyclerViewParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mHeight);
